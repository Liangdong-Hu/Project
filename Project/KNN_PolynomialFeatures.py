...
Polynomial = PolynomialKNN(degree=2)
print('KNN_P score: %f' % Polynomial.fit(X_train, y_train).score(X_test, y_test))
...
print('KNN_P ROC auc: %f' % auc(fpr, tpr))
print('KNN_P PR auc: %f' % auc(recall, precision))
print('KNN_P PR ap: %f' % metrics.average_precision_score(y_test, y_score[:, 1]))
